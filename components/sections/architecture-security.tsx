  ...
  const generateArchRecommendation = useCallback(() => {
    ...
    archRecommendation.startStream({
      ...
      body: {
        ...
        account,
        competitors,
        context: `Generate a detailed recommendation for deploying and expanding Everpure (formerly Pure Storage) at ${account.name}. Their existing vendors include: ${account.existingVendorFootprint.join(", ")}. Security sensitivity: ${account.securitySensitivity}/100. Compliance complexity: ${account.complianceComplexity}/100.\n\nInclude:\n1. Recommended rollout approach (phased by workload or team)\n2. Integration with their existing stack (virtualization, databases, backup, imaging, AI pipelines)\n3. Security posture and access controls\n4. Compliance considerations\n5. Phased rollout plan\n6. Prerequisites and potential blockers`,
      },
    });
